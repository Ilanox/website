...
const member = [
  ...
  },
 {
  ...
  {
    avatar: 'https://www.github.com/ilanox.png',
    name: 'Ilan Levy',
    title: 'Community Manager',
    links: [
      { icon: 'github', link: 'https://github.com/ilanox' },
      { icon: 'discord', link: 'https://discord.com/users/302904462123466752' },
      { icon: 'linkedin', link: 'https://il.linkedin.com/in/ilan-levy-3a4178356' },
      { 
        icon: {
            svg: '<svg xmlns="http://www.w3.org/2000/svg" width="36px" height="36px" viewBox="0 0 24 24"><path fill="currentColor" d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2m0 4l-8 5l-8-5V6l8 5l8-5z"></path></svg>'
        }, 
        link: 'mailto:ilan@edvin.co.il'
      }
    ]
  },
{
